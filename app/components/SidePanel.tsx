			...
			<div className="flex flex-col items-center justify-center bg-[#303638] border-b-4 border-b-[#131A1C] rounded-xl w-full">
				...
				<div className="flex flex-row items-center justify-center gap-4 w-full m-2">
					...
					<div className="flex flex-col items-center justify-center w-[60%] xl:w-[65%] bg-[#1A2527] border-b-4 border-[#131A1C] rounded-xl">
						...
						<a href={gitHubUrl} target="_blank" rel="noopener noreferrer" className="flex flex-row items-center justify-center gap-2 text-2xl"><FaGithub /> <span className="text-[#E6504A] text-xl xl:text-3xl text-shadow-none">GitHub</span></a>
						<div className="flex flex-row items-center justify-center gap-2"><span className="text-md xl:text-lg">Reward:</span> <FloatingText intensity={0.5} className="text-[#EAAE6C] text-xl xl:text-2xl text-shadow-none">¯\_(ツ)_/¯</FloatingText></div>
					</div>
				</div>
			</div>
		</div>
...
function Location({ location }: LocationProps) {
	return (
		<div className="flex flex-row items-center justify-evenly bg-[#414143] w-full rounded-xl border-b-4 border-[#131A1C]">
			...
			<div className="flex flex-row items-center justify-center bg-[#283032] rounded-xl p-1 pl-4 pr-4 gap-2 w-full m-2"><FaLocationDot /> <span className="text-xl xl:text-2xl">{location}</span></div>
		</div>
	);
}
				...
				<div className="flex flex-col items-center justify-center gap-2 w-full h-full">
					<div className="flex flex-row items-center justify-center gap-2 w-full">
						<div className="flex flex-col items-center justify-evenly bg-[#414143] w-full rounded-xl border-b-4 border-[#131A1C] p-1">
							<span className="text-xl xl:text-2xl">Mail</span>
						...
						<div className="flex flex-col items-center justify-evenly bg-[#414143] w-full rounded-xl border-b-4 border-[#131A1C] p-1">
							<span className="text-xl xl:text-2xl">Matrix</span>
					...
					<div className="flex flex-row items-center justify-center gap-2 w-full">
						<div className="flex flex-col items-center justify-evenly bg-[#414143] w-full rounded-xl border-b-4 border-[#131A1C] p-1">
							<a href={props.linkedInUrl} target="_blank" rel="noopener noreferrer" className="flex flex-row items-center justify-center bg-[#283032] rounded-xl p-1 pl-4 pr-4 gap-2 w-full">
								<FaLinkedin className="text-xl xl:text-2xl" /> <span className="text-lg xl:text-3xl">{props.linkedInId}</span>
							</a>
						</div>
					</div>
					<div className="flex flex-row items-center justify-center gap-2 w-full">
						<div className="flex flex-col items-center justify-evenly bg-[#414143] w-full rounded-xl border-b-4 border-[#131A1C] p-1">
							<span className="text-xl xl:text-2xl">Steam</span>
						...
						<div className="flex flex-col items-center justify-evenly bg-[#414143] w-full rounded-xl border-b-4 border-[#131A1C] p-1">
							<span className="text-xl xl:text-2xl">Instagram</span>
