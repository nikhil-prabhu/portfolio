...
export const MetaBar = ({ children }: { children: React.ReactNode }) => (
	<div className="flex flex-col xl:flex-row text-xl xl:text-2xl items-stretch xl:items-center justify-between bg-[#C2BFD7] border-b-4 border-[#606B72] rounded-xl p-1 gap-2 xl:gap-4 w-full overflow-hidden shrink-0">
		{children}
	</div>
);

export const MetaPill = ({ children }: { children: React.ReactNode }) => (
	<span className="bg-white text-[#516164] rounded-xl p-2 px-4 shrink-0 shadow-sm text-shadow-none w-full xl:w-auto text-center">
		{children}
	</span>
);

export const MetaTitle = ({ children }: { children: React.ReactNode }) => (
	<span className="flex-1 min-w-0 text-center px-2 w-full xl:w-auto">
		{children}
	</span>
);
...
export const MetaDataBlock = ({
	...
	<div className="flex flex-row items-center justify-center bg-[#10181A] border-4 border-[#10181A] rounded-xl overflow-hidden shrink-0 h-full w-full xl:w-auto">
		<div className="bg-[#0F8FFA] rounded-xl px-4 py-1 flex-1 xl:flex-none">
		...
		<div className="bg-[#FC4B43] rounded-xl px-4 py-1 flex-1 xl:flex-none">
